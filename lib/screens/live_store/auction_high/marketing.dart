...
class AuctionHighHeader extends StatefulWidget {
  const AuctionHighHeader({Key key}) : super(key: key);

  @override
  _AuctionHighHeaderState createState() => _AuctionHighHeaderState();
}

class _AuctionHighHeaderState extends State<AuctionHighHeader> {
  int _currentPage = 0;
  final images = [
                ...
                Row(
                  ...
                  children: [
                    Container(
                        width: 25,
                        height: 30.18,
                        child: Image.asset('assets/images/auction_high.png'))
                  ],
                )
              ],
            ),
