...
class EcommerceHeader extends StatefulWidget {
  const EcommerceHeader({Key key}) : super(key: key);

  @override
  _EcommerceHeaderState createState() => _EcommerceHeaderState();
}

class _EcommerceHeaderState extends State<EcommerceHeader> {
  int _currentPage = 0;
  final images = [
