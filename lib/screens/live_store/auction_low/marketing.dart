...
class AuctionLowHeader extends StatefulWidget {
  const AuctionLowHeader({Key key}) : super(key: key);

  @override
  _AuctionLowHeaderState createState() => _AuctionLowHeaderState();
}

class _AuctionLowHeaderState extends State<AuctionLowHeader> {
  int _currentPage = 0;
  final images = [
                ...
                Row(
                  ...
                  children: [
                    Container(
                        width: 25,
                        height: 30.17,
                        child: Image.asset('assets/images/auction_low.png'))
                  ],
                )
              ],
            ),
